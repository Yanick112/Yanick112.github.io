...
useEffect(() => {
  ...
  // 将 inputResult 映射为 SearchResult 类型，确保 matches 始终为数组类型
  const formattedResults = inputResult.map(result => ({
    ...result,
    matches: result.matches || [] // 如果 matches 为 undefined，将其设为空数组
  })) as SearchResult[];
